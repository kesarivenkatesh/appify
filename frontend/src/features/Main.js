      ...
      <div className="page-container">
        ...
        <section className="hero-section">
          <div className="hero-content">
            ...
            <button className="primary-button"><Link to="/Register">
            Start Your Journey
            <Heart size={20} />
            </Link>
        ...
        <section className="cta-section">
          <div className="cta-container">
            ...
            <p className="cta-description">
              Join our community of people committed to improving their mental
              health. Get access to tools, resources, and support to help you on
              your journey.
            </p>
            <button className="primary-button"><Link to='/Register'>
            Join Now
